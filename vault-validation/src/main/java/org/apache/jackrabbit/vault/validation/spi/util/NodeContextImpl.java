...
public final class NodeContextImpl implements NodeContext {
    ...
    public NodeContextImpl(
            @NotNull String nodePath, @NotNull Path filePath, @NotNull Path basePath, int line, int column) {
    ...
    public NodeContextImpl(
            ...
            int line,
            int column,
            @NotNull Function<Name, String> jcrNameResolver) {
        super();
    ...
    public String toString() {
        return "NodeContextImpl [nodePath=" + nodePath + ", filePath=" + filePath + ", basePath=" + basePath + ", line="
                + line + ", column=" + column + "]";
    }
}
