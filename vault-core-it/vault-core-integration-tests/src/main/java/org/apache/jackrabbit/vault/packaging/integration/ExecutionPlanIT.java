...
public class ExecutionPlanIT extends IntegrationTestBase {
    ...
    public void testSerialization() throws IOException, PackageException {
        ...
        builder.addTask()
                .with(idB)
                .with(PackageTask.Type.EXTRACT)
                .addTask()
                .with(idC)
                .with(PackageTask.Type.INSTALL)
                .addTask()
                .with(idC)
                .with(PackageTask.Type.REMOVE)
                .addTask()
                .with(idC)
                .with(PackageTask.Type.UNINSTALL)
                .save(out);
        ...
        registry.createExecutionPlan()
                .load(new ByteArrayInputStream(expected.getBytes("utf-8")))
                .save(out);
    ...
    public void testUninstallTask() throws IOException, PackageException {
        ...
        assertFalse(
                ...
                registry.open(TEST_PACKAGE_ID_A_10).isInstalled());
    }
    ...
    public void testUninstallAutomaticDependenciesTask() throws IOException, PackageException {
        ...
        assertFalse(
                ...
                registry.open(TEST_PACKAGE_ID_B_10).isInstalled());
        assertFalse(
                "package C is not installed",
                registry.open(TEST_PACKAGE_ID_C_10).isInstalled());
    }
    ...
    public void testStackedExecutionPlans() throws IOException, PackageException {
        ...
        assertEquals(
                "builder2 only contains 1 PackageTask", 1, builder2.preview().size());
