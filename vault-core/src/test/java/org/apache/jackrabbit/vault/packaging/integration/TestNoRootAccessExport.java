...
public class TestNoRootAccessExport extends IntegrationTestBase {
    ...
    public void exportNoRootAccess() throws RepositoryException, IOException, PackageException {
        ...
        Node packageRoot = new JcrPackageManagerImpl(admin, new String[0], null, null).getPackageRoot();
        ...
        Node tmpNode = new JcrPackageManagerImpl(admin, new String[0], null, null).getPackageRoot();
