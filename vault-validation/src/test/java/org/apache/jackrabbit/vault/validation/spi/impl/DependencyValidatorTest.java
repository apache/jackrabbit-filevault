...
public class DependencyValidatorTest {
    ...
    public void setUp() throws ParserConfigurationException, SAXException {
        ...
        validator = new DependencyValidator(
                ValidationMessageSeverity.ERROR, ValidationMessageSeverity.ERROR, resolvedPackageInfos);
    }
    ...
    public void testWithResolvedNonOverlappingDependency() {
        ...
        resolvedPackageInfos.add(
                getPackageInfo("group2:package2:2.9", "/simple-package/META-INF/vault/filter.xml", null));
    ...
    public void testValidateWithUnresolvedDependencies() {
        ...
        MatcherAssert.assertThat(
                validator.validate(properties),
                Matchers.contains(new ValidationMessage(
                        ValidationMessageSeverity.ERROR,
                        String.format(String.format(
                                DependencyValidator.MESSAGE_UNRESOLVED_DEPENDENCY, "group2:package2:(2,3)")))));
    }

    @Test
    public void testValidateWithDependenciesWithOverlappingFilterRoots() {
        resolvedPackageInfos.add(
                getPackageInfo("group1:package1:0.1", "/simple-package/META-INF/vault/filter.xml", null));
        resolvedPackageInfos.add(
                getPackageInfo("group2:package2:2.9", "/simple-package/META-INF/vault/filter.xml", null));
        MatcherAssert.assertThat(
                validator.validate(properties),
                Matchers.contains(new ValidationMessage(
                        ...
                        String.format(String.format(String.format(
                                DependencyValidator.MESSAGE_DEPENDENCIES_WITH_OVERLAPPING_FILTERS,
                                "group2:package2:2.9",
                                "/etc/project1",
                                "group1:package1:0.1"))))));
    }
