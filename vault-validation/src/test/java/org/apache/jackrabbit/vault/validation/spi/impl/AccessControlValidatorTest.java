...
public class AccessControlValidatorTest {
    ...
    public void testWithACLsAndMerge() {
        ...
        Collection<ValidationMessage> messages = validator.validate(
                node, new NodeContextImpl("/apps/test/deep", Paths.get(".content.xml"), Paths.get("base")), false);
    ...
    public void testWithoutACLsAndMerge() {
        ...
        ValidationExecutorTest.assertViolation(
                ...
                new ValidationMessage(
                        ...
                        String.format(
                                AccessControlValidator.MESSAGE_INEFFECTIVE_ACCESS_CONTROL_LIST,
    ...
    public void testWithACLsAndClear() {
        ...
        ValidationExecutorTest.assertViolation(
                ...
                new ValidationMessage(
                        ValidationMessageSeverity.ERROR,
                        String.format(
                                AccessControlValidator.MESSAGE_IGNORED_ACCESS_CONTROL_LIST,
