                ...
                .withChildren(new GroupBuilder()
                        ...
                        .withOption(
                                optRecursive = new DefaultOptionBuilder()
                                        ...
                                        .create())
                        .withOption(
                                optSize = new DefaultOptionBuilder()
                                        .withShortName("b")
                                        ...
                                        .create())
                        .withOption(
                                optThrottle = new DefaultOptionBuilder()
                                        .withShortName("t")
                                        ...
                                        .create())
                        .withOption(
                                optResumeFrom = new DefaultOptionBuilder()
                                        .withShortName("R")
                                        .withLongName("resume")
