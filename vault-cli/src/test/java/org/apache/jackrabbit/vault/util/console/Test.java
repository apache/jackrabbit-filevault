...
public class Test {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Option recursive = obuilder.withShortName("r")
                .withLongName("recursive")
                .withDescription("do recursively")
                .create();
        Command update = cbuilder.withName("update")
                .withName("up")
        ...
        Option projecthelp = obuilder.withShortName("projecthelp")
                ...
                .create();
        Option version = obuilder.withShortName("v")
                .withDescription("print the version information and exit")
                .create();

        Group options = gbuilder.withName("Global options:")
        ...
        Option command =
                abuilder.withName("command").withMinimum(1).withMaximum(1).create();
        ...
        Group commands = gbuilder.withName("Commands:")
