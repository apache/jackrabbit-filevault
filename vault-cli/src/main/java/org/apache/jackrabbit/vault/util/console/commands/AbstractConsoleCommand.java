...
public abstract class AbstractConsoleCommand extends AbstractCommand implements ConsoleCommand {
    ...
    public boolean execute(ConsoleExecutionContext ctx, CommandLine cl) throws Exception {
    ...
    protected abstract void doExecute(ConsoleExecutionContext ctx, CommandLine cl) throws Exception;
}
