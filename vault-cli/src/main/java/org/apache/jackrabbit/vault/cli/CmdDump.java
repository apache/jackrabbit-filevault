        ...
        if (fs == null) {
            ...
            if (cl.hasOption(optConfig) || cl.hasOption(optFilter)) {
                ...
                if (f instanceof Dumpable) {
                    DumpContext dCtx = new DumpContext(
                            new PrintWriter(new OutputStreamWriter(System.out, StandardCharsets.US_ASCII)));
            ...
            fs.getAggregateManager()
                    .dumpConfig(new PrintWriter(new OutputStreamWriter(System.out, StandardCharsets.US_ASCII)));
        }
    }
