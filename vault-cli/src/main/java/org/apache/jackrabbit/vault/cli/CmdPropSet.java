...
public class CmdPropSet extends AbstractVaultCommand {
    ...
    protected void doExecute(VaultFsApp app, CommandLine cl) throws Exception {
        ...
        PropSet a = new PropSet(
                localDir, localFiles, !cl.hasOption(optRecursive), (String) cl.getValue(argPropName), (String)
                        cl.getValue(argPropValue));
        vCtx.execute(a);
    }
                ...
                .withChildren(new GroupBuilder()
                        ...
                        .withOption(
                                optRecursive = new DefaultOptionBuilder()
                                        ...
                                        .create())
                        .withOption(
                                argPropName = new ArgumentBuilder()
                                        .withName("propname")
                                        ...
                                        .create())
                        .withOption(
                                argPropValue = new ArgumentBuilder()
                                        .withName("propval")
