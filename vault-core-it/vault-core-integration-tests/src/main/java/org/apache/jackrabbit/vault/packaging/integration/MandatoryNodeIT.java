...
public class MandatoryNodeIT extends IntegrationTestBase {
    ...
    @Test
    public void testMandatoryResidualChildNodesReplace() throws RepositoryException, IOException, PackageException {
    ...
    @Test
    public void testMandatoryNonResidualChildNodesReplace()
            throws ItemExistsException, PathNotFoundException, NoSuchNodeTypeException, LockException, VersionException,
                    ConstraintViolationException, RepositoryException, IOException, PackageException {
