...
public class DuplicateUuidValidatorTest {
    ...
    public void testWithDuplicates() {
        ...
        DocViewNode2 node = new DocViewNode2(
                NameConstants.JCR_ROOT, Collections.singleton(new DocViewProperty2(NameConstants.JCR_UUID, "1")));
        ...
        node = new DocViewNode2(
                NameConstants.JCR_ROOT, Collections.singleton(new DocViewProperty2(NameConstants.JCR_UUID, "2")));
        MatcherAssert.assertThat(
                validator.validate(
        ...
        ValidationExecutorTest.assertViolation(
                ...
                new ValidationMessage(
                        ...
                        String.format(
                                DuplicateUuidValidator.MESSAGE_DUPLICATE_UUID,
                                "1",
                                "/apps/test/node1",
                                "/apps/test/node3")));
