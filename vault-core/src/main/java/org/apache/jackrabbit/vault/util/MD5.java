...
public class MD5 {
    ...
    public MD5(String str) {
        ...
        msb = (Long.parseLong(str.substring(0, 8), 16) << 32) + (Long.parseLong(str.substring(8, 16), 16));
        lsb = (Long.parseLong(str.substring(16, 24), 16) << 32) + (Long.parseLong(str.substring(24, 32), 16));
    }
