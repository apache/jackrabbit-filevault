...
public class DefaultPathFilterTest {
    ...
    public void testFilterSetGetDirectChildNameTowardsFilterRoot() {
        ...
        assertEquals(
                "root path below path, expects last segment of filter root",
                "d",
                fs.getDirectChildNameTowardsFilterRoot("/a/b/c"));
        assertEquals(
                "root path below path, expects last segment of filter root",
                "d",
                fs.getDirectChildNameTowardsFilterRoot("/a/b/c/"));
        ...
        assertEquals(
                "root path below path, expects last segment of filter root",
                "c",
                fs.getDirectChildNameTowardsFilterRoot("/a/b"));
        assertEquals(
                "root path below path, expects last segment of filter root",
                "c",
                fs.getDirectChildNameTowardsFilterRoot("/a/b/"));
        ...
        assertEquals(
                "unrelated root path, expects empty string", "", fs.getDirectChildNameTowardsFilterRoot("/foo/bar"));
        assertEquals(
                "unrelated root path, expects empty string", "", fs.getDirectChildNameTowardsFilterRoot("/foo/bar/"));
    }
