...
public class ValidatorException extends RuntimeException {
    ...
    public ValidatorException(
            String id, RuntimeException e, Path filePath, int lineNumber, int columnNumber, Throwable cause) {
        this(
                id,
                " while validating file '" + filePath + "' (line " + lineNumber + ", column " + columnNumber + ")",
                cause);
    }
