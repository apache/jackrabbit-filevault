...
public class HtmlProgressListenerTest {
    ...
    public void testXSSOnMessage() {
        ...
        assertEquals(
                "<span class=\"A\"><b>A</b>&nbsp;&lt;script&gt;alert(&apos;hello&apos;);&lt;/script&gt;</span><br>\r\n",
                out.toString());
    }
    ...
    public void testSimpleOnError() {
        ...
        assertEquals(
                "<span class=\"E\"><b>E</b>&nbsp;/content/foo (java.lang.Exception: Test Exception)</span><br>\r\n",
                out.toString());
    }
    ...
    public void testXSSOnError() {
        ...
        l.setNoScrollTo(true);
        l.onError(
                ProgressTrackerListener.Mode.PATHS, "/content/foo", new Exception("<script>alert('hello');</script>"));
        assertEquals(
                "<span class=\"E\"><b>E</b>&nbsp;/content/foo (java.lang.Exception: &lt;script&gt;alert(&apos;hello&apos;);&lt;/script&gt;)</span><br>\r\n",
                out.toString());
    }
}
